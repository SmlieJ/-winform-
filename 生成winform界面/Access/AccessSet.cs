...
namespace 生成winform界面.Access
{
    class AccessSet
    {
        public static readonly string conn_str = "Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + AppDomain.CurrentDomain.BaseDirectory + System.Configuration.ConfigurationSettings.AppSettings["Accessconn"].ToString() + ";Persist Security Info=True";
